...
def training(
    ...
    decorators = [Summary(detailed=detailed), Reference(ref)]
    ...
    for decorator in decorators:
        decorator(history, {"model": model, "data": (X, y), "data_val": (X_val, y_val)})
    ...
    #     format='onnx'
    # )
    model.export(filepath=output_dir + "/model.tf", format="tf_saved_model")
